...
public class TrafficInfo {
	...
	public long getTrafficInfo() {
		...
		rcvTraffic = TrafficStats.getUidRxBytes(Integer.parseInt(uid));//993072
		sndTraffic = TrafficStats.getUidTxBytes(Integer.parseInt(uid));//522187
		...
		try {
			...
			rcvTraffic = Long.parseLong(rafRcv.readLine());//459204
			sndTraffic = Long.parseLong(rafSnd.readLine());//185666
		...
		if (rcvTraffic == UNSUPPORTED || sndTraffic == UNSUPPORTED) {
			...
			return rcvTraffic + sndTraffic;//644870
	}
}
