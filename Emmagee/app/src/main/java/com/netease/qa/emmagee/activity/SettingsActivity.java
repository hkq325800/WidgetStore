...
public class SettingsActivity extends Activity {
		...
		layHeapItem.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (isChecked) {
					...
					boolean root = upgradeRootPermission(getPackageCodePath());//判断是否root
					if (root) {
	...
	public static boolean upgradeRootPermission(String pkgCodePath) {
		...
		try {
			String cmd = "chmod 777 " + pkgCodePath;//chmod 777 /data/app/com.netease.qa.emmagee.emmagee-2.apk
