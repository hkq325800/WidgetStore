...
import com.dpizarro.uipicker.library.picker.PlacePickerUI;
import com.dpizarro.uipicker.library.picker.Province;
        ...
        mPickerUI.setOnClickItemPickerUIListener(
                new PlacePickerUI.PlacePickerUIItemClickListener() {
                    ...
                    public void onItemClickPickerUI(int which, int position, String valueResult) {
                        Log.d("placePicker", valueResult + "第" + which + "列");
//                        Toast.makeText(MainActivity.this, valueResult + "第" + which + "列", Toast.LENGTH_SHORT).show();
                    }
                });
