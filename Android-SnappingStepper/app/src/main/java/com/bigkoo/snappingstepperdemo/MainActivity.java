...
//        stepper.setLeftButtonResources(R.mipmap.ic_undo_gray);
//        stepper.setRightButtonResources(R.mipmap.ic_redo_gray);
//        stepper.setBackgroundResource(R.color.backgroundFunctionBar);
